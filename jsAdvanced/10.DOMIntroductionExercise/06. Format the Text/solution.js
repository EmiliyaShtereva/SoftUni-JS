...
// JavaScript, often abbreviated as JS, is a high-level, interpreted programming language. It is a language which is also characterized as dynamic,
//  weakly typed, prototype-based and multi-paradigm.
//  JavaScript, often abbreviated as JS,
//  is a high-level, interpreted programming language. It is a language which is also characterized as dynamic, weakly typed,
...
// JavaScript enables interactive web pages and thus is an essential part of web applications. The vast majority of websites use it,
...
//  (including object-oriented and prototype-based) programming styles. It has an API for working with text, arrays, dates,
//   regular expressions, and basic manipulation of the DOM,
//   but the language itself does not include any I/O, such as networking,
