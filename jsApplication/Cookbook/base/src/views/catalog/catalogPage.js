export class CatalogPage {
    ...
    async _showCatalog(ctx) {
        ...
        if (ctx.querystring) {
            ...
            this.recipes = await this.recipeService.getRecipesWithSelectedColums(['_id', 'name', 'img']);
        }
        ...
        // let result = await this.modalService.showModal('Are you sure tou want to delete this item?');
        // console.log(result);
    }
